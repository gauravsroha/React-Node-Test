        ...
        <>
            {isLoding ?
                <Flex justifyContent={'center'} alignItems={'center'} width="100%" >
                            ...
                            <Card>
                                <Grid gap={4}>
                                    ...
                                    <GridItem colSpan={{ base: 2, md: 1 }}>
                                        ...
                                        <Text>{data?.dateTime ? moment(data?.dateTime).format('DD-MM-YYYY h:mma') : ' - '}</Text>
                                    </GridItem>
                                    <GridItem colSpan={{ base: 2, md: 1 }}>
                                    ...
                                    <GridItem colSpan={{ base: 2, md: 1 }}>
                                        ...
                                        <Text> {data?.createdDate ? moment(data?.createdDate).format('DD-MM-YYYY  h:mma ') : ' - '} [{data?.createdDate ? moment(data?.createdDate).toNow() : ' - '}]</Text>
                                    </GridItem>
                                    <GridItem colSpan={{ base: 2, md: 1 }}>
                    ...
                    {(user.role === 'superAdmin' || permission?.delete) && <Card mt={3}>
